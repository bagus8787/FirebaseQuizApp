...
import com.naman.firebasequizapp.admin.CategoryModel;
...
public class QuizActivity extends AppCompatActivity {
    ...
    TextView q,t,o1,o2,o3,o4,ca,hin,nt,ni, id_kat;
//    MediaPlayer c,w,to;
    int nilai=0;
    int correct=0;
    int wrong=0;
...
//        to=MediaPlayer.create(this,R.raw.to);
        ...
        id_kat = findViewById(R.id.txt_id_kategori);
...
//            Collections.shuffle(list);
        ...
        if(total>=5)
        {
            ...
            result.putExtra("nilai", valueOf(nilai));
...
//                    next.setVisibility(View.VISIBLE);
    ...
    {
        t=findViewById(R.id.timer);
        timer=new CountDownTimer(seconds*10000+10000,10000)
        {
            @Override
...
//                    to.start();
                    ...
                    myIntent.putExtra("nilai", valueOf(nilai));
